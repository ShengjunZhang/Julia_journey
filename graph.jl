...
"""
This function is used to compute the Laplacian matrix for a given Adjacency
    matrix and degree
# Arguments
- 'Adj::Array{Float64, 2}': the adjacency matrix of a given graph
- 'degree::Array{Float64, 2}': the associated degree vector
"""

function laplacian_matrix(Adj::Array{Float64, 2}, degree::Array{Float64, 2})
    L = diagm(degree[:]) .- Adj
    return L
end
